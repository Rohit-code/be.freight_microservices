...
def generate_jwt_token(user_id: int, email: str, is_staff: bool = False, is_superuser: bool = False) -> str:
    """Generate JWT token for authenticated user. is_staff/is_superuser used by order service for tracking updates."""
    payload = {
        'user_id': user_id,
        'email': email,
        'is_staff': is_staff,
