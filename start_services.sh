...
trap "kill $AUTH_PID $CONSTANTS_PID $AI_PID $VECTOR_PID $EMAIL_PID $USER_PID $RATE_SHEET_PID $GRAPH_PID $INTENT_PID $ORCHESTRATOR_PID $DECISION_PID $GATEWAY_PID; exit" INT TERM
wait
