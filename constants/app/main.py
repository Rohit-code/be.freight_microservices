...
try:
    ...
    logger = setup_service_logging("constants", suppress_warnings=True)
...
async def startup_event():
    if USE_SHARED_LOGGING:
        log_service_startup(logger, "constants", 8002, "0.1.0")
        log_service_ready(logger, "constants")
    else:
        logger.info("🚀 Constants Service v0.1.0 - Port 8002")
        logger.info("✅ Constants Service Ready")
