...
class Route(Base):
    ...
    # Vessel/route capacity - space left (e.g. TEUs or containers)
    space_available = Column(Integer, nullable=True)  # e.g. 20 TEUs left
    space_unit = Column(String(20), nullable=True)  # e.g. "TEU", "container"
