...
class Settings(BaseSettings):
    ...
    # Order Service (for creating order when customer accepts quote)
    ORDER_SERVICE_URL: str = "http://localhost:8015"
    # Customer Service (for resolving customer by email)
    CUSTOMER_SERVICE_URL: str = "http://localhost:8016"
    # Internal API key for order/customer service calls
